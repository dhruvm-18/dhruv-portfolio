...
"Prepared for and gained exposure to the AWS Certified Cloud Practitioner exam objectives"
  ...
  rel="noopener noreferrer" aria-label="Mail" className="p-2 rounded-full transition-colors duration-200 hover:bg-cyan-900/40"> <Mail className={`w-6 h-6 ${isDarkMode ? 'text-cyan-300' : 'text-cyan-600'}`} /> </a>
      ...
      <section id="projects" className="py-16 px-4 sm:px-6 md:py-20">
        <div className="max-w-6xl mx-auto">
          ...
          >
            ...
            <p className={`text-base md:text-lg ${isDarkMode ? 'text-slate-300' : 'text-gray-400'} mb-2`}>Here are some of my projects spanning full-stack development, data analysis, and cloud computing.</p>
            <p className={`text-sm ${isDarkMode ? 'text-slate-400' : 'text-gray-500'} italic`}>💡 <span className="font-medium">Hover over project images to see detailed previews</span></p>
          </FadeIn>
            ...
            {filteredProjects.map((project, index) => (
              ...
              >
                ...
                <div 
                  ...
                  onMouseEnter={() => {
                    if (!project.title.includes('Hybrid Stock Price Prediction') && !project.title.includes('Railway Ticketing Chatbot')) {
              ...
              {[
                ...
                >
                  ...
                  <div className="p-6 md:p-8 text-center">
                    ...
                    <div className={`px-4 py-2 rounded-full text-sm font-medium ${isDarkMode ? 'bg-white/10 text-white' : 'bg-gray-100 text-gray-700'} border border-white/20`}>
                      {contact.action}
                    </div>
                  </div>
                </motion.div>
      ...
      {/* Enhanced Location & About Section */}
      <section className="py-12 px-4 sm:px-6 md:py-16">
        <div className="max-w-6xl mx-auto">
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            ...
            {/* Center: Delhi State Map */}
            <div className={`relative rounded-2xl border shadow-2xl overflow-hidden ${isDarkMode ? 'border-blue-800 bg-slate-900' : 'border-blue-200 bg-white'}`} style={{ width: '100%', height: 300, minHeight: 250 }}>
              {/* Delhi State Outline Map */}
            ...
            <div className={`${cardClasses} rounded-2xl border shadow-xl p-6 md:p-8 backdrop-blur-2xl`}>
              <h4 className="text-xl md:text-2xl font-bold mb-4">Quick Connect</h4>
              <div className="space-y-3">
                <a href="https://mail.google.com/mail/?view=cm&fs=1&to=dhruv.mendiratta4@gmail.com" target="_blank" rel="noopener noreferrer" className={`flex items-center gap-3 p-3 rounded-lg ${isDarkMode ? 'bg-white/10 hover:bg-white/20' : 'bg-gray-100 hover:bg-gray-200'} transition-all duration-200`}>
                  <Mail className="w-5 h-5 text-blue-500" />
                  <span className="text-sm font-medium">Send Email</span>
                </a>
                <a href="https://www.linkedin.com/in/dhruv-mendiratta-132a46255/" target="_blank" rel="noopener noreferrer" className={`flex items-center gap-3 p-3 rounded-lg ${isDarkMode ? 'bg-white/10 hover:bg-white/20' : 'bg-gray-100 hover:bg-gray-200'} transition-all duration-200`}>
                  <Linkedin className="w-5 h-5 text-blue-600" />
                  <span className="text-sm font-medium">Connect on LinkedIn</span>
                </a>
                <a href="https://github.com/dhruvm-18" target="_blank" rel="noopener noreferrer" className={`flex items-center gap-3 p-3 rounded-lg ${isDarkMode ? 'bg-white/10 hover:bg-white/20' : 'bg-gray-100 hover:bg-gray-200'} transition-all duration-200`}>
              ...
              <div className="mt-4 p-3 rounded-lg bg-gradient-to-r from-blue-500/10 to-purple-500/10 border border-blue-500/20">
                <div className="text-xs text-center font-medium">🚀 Let's build something great together!</div>
              </div>
            </div>
          </div>
        </div>
